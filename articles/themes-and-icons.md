...
This example deliberately mixes icon sources and moves the activity bar
to the right. It also demonstrates that the page follows a custom bslib
theme.
...
[View the original
`app.R`](https://github.com/jbkunst/bscode/blob/main/inst/examples/05-themes-icons/app.R)
