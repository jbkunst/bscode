...
Sidebar mode keeps the same navigation model as the compact activity
bar. Only its presentation changes: section labels remain visible and
the brand can use the full width.
...
- [`nav_panel()`](https://rstudio.github.io/bslib/reference/nav-items.html),
  [`nav_spacer()`](https://rstudio.github.io/bslib/reference/nav-items.html),
  and
...
[Open live app](https://jkunst.com/bscode/live/examples/06-sidebar/)
...
[View the original
`app.R`](https://github.com/jbkunst/bscode/blob/main/inst/examples/06-sidebar/app.R)
